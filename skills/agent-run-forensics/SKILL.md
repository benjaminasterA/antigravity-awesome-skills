...
description: Use when investigating what a past agent run actually did, reproducing a failure someone reported, or turning a failed session into an offline regression test.
---
